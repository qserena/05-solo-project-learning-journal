export function getArticlePreviewText() {
	return `After several months of learning in the Frontend Developer Career Path, I've made the big jump over to the Bootcamp to get expert code reviews of my Solo Projects projects and meet like-minded peers.`
}

export function getArticleLast() {
	return `<p><strong>How I stay committed to learning</strong></p>
...
export function getPostText() {
	return `I'm excited to start a new learning journey as a Scrimba Bootcamp student! After several months of learning in the Frontend Developer Career Path.</p>`
}
